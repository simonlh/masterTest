...
\pretolerance = 2000
\begin{document}
Tufte brings up the choice of color for representing and illuminating information. He recommend using colors found in nature. Specifically light blue, yellows, grays. 

Strongly muted colors mixed with gray can serve as background. 
Value scales - gradients may be vunerable to inaccuracies as visual contextual effects disturb. 
Rainbow scales do not translate naturally to human vision. Spectrums are not understood by the mind as inherently sequential. 
